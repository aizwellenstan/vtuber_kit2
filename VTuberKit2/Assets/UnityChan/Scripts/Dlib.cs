...
//{
  //  [RequireComponent(typeof(Animator))]
	...
	void Start ()
        ...
        void Update() 
        {
		lookPos = Quaternion.Euler(pitch, yaw, roll) * Camera.main.transform.position;	
		//lookPos = Quaternion.Euler(pitch, yaw, roll) * new Vector3 (0, 0, 0);		
    	
	//	UnityEngine.Debug.Log("-----------------------");
	//	UnityEngine.Debug.Log("lookPos "+lookPos);
			// set paramters
